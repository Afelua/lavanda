	...
	jQuery(document).ready(function(){
	 ...
	 // Portfolio Ajax
			...
			if(typeof loader.html() == 'undefined'){
				$('<div class="expander-wrap"><div id="expander-wrap" class="container clearfix relative"><p class="cls-btn1"><a class="close">Z</a></p><div/></div></div>').css({opacity:0}).hide().insertAfter('.portfolio');
